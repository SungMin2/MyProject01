...
public class Dowhat_shop extends AppCompatActivity {
    LinearLayout layout = null;
    RecyclerView recyclerview;
    TextView dowhat_shop_date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dowhat_shop);

        recyclerview = (RecyclerView) findViewById(R.id.shop_rv);

        GetXMLTask1 task1 = new GetXMLTask1();
        task1.execute("http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList?serviceKey=JI5iaAMofKW0PgTEzjqzA38Ut65niZWOSb2qDUs%2BXHVBM10SOY8toEJhq4ESw0rWBNtG%2BBIVJNMXNDkSt9H15g%3D%3D&MobileOS=AND&MobileApp=MyProject01&arrange=C&numOfRows=10&contentTypeId=38");


        dowhat_shop_date = (TextView) findViewById(R.id.dowhat_shop_date);
        ...
        dowhat_shop_date.setText(title_tv + "  " + dowhat_date);
    }
    ...
    private class GetXMLTask1 extends AsyncTask<String, Void, Document>{
        ...
        protected void onPostExecute(Document doc) {
            List<Shop_view> shop_views = new ArrayList<Shop_view>();

            NodeList nodeList = doc.getElementsByTagName("item");

            for(int i = 0; i< nodeList.getLength(); i++) {
                Shop_view shop_view = new Shop_view();
                ...
                shop_view.setNum(i+1+"");
                shop_view.setTitle(title);
                shop_view.setImgURL(url);
                shop_view.setInfo(overview);
                shop_view.setAddress(address);
                shop_view.setTel(tel);

                shop_views.add(shop_view);
            ...
            recyclerview.setAdapter(new MyShopAdapter(shop_views, R.layout.activity_shop_view));
