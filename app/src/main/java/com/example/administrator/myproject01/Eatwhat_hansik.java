...
public class Eatwhat_hansik extends AppCompatActivity {
    LinearLayout layout = null;
    RecyclerView recyclerview;
    TextView eatwhat_hansik_date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eatwhat_hansik);

        recyclerview = (RecyclerView) findViewById(R.id.hansik_rv);

        GetXMLTask1 task1 = new GetXMLTask1();
        task1.execute("http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList?serviceKey=JI5iaAMofKW0PgTEzjqzA38Ut65niZWOSb2qDUs%2BXHVBM10SOY8toEJhq4ESw0rWBNtG%2BBIVJNMXNDkSt9H15g%3D%3D&MobileOS=AND&MobileApp=MyProject01&arrange=C&numOfRows=10&contentTypeId=39&cat3=A05020100");


        eatwhat_hansik_date = (TextView) findViewById(R.id.eatwhat_hansik_date);
        ...
        eatwhat_hansik_date.setText(title_tv + "  " + eatwhat_date);
    }
    ...
    private class GetXMLTask1 extends AsyncTask<String, Void, Document>{
        ...
        protected void onPostExecute(Document doc) {
            List<Hansik_view> hansik_views = new ArrayList<Hansik_view>();

            NodeList nodeList = doc.getElementsByTagName("item");

            for(int i = 0; i< nodeList.getLength(); i++) {
                Hansik_view hansik_view = new Hansik_view();
                ...
                hansik_view.setNum(i+1+"");
                hansik_view.setTitle(title);
                hansik_view.setImgURL(url);
                hansik_view.setInfo(overview);
                hansik_view.setAddress(address);
                hansik_view.setTel(tel);

                hansik_views.add(hansik_view);
            ...
            recyclerview.setAdapter(new MyHansikAdapter(hansik_views, R.layout.activity_hansik_view));
