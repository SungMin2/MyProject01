...
public class Dowhat_hotel extends AppCompatActivity {
    LinearLayout layout = null;
    RecyclerView recyclerview;
    TextView dowhat_hotel_date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dowhat_hotel);

        recyclerview = (RecyclerView) findViewById(R.id.hotel_rv);

        GetXMLTask1 task1 = new GetXMLTask1();
        task1.execute("http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList?serviceKey=JI5iaAMofKW0PgTEzjqzA38Ut65niZWOSb2qDUs%2BXHVBM10SOY8toEJhq4ESw0rWBNtG%2BBIVJNMXNDkSt9H15g%3D%3D&MobileOS=AND&MobileApp=MyProject01&arrange=C&numOfRows=10&contentTypeId=32");

        dowhat_hotel_date = (TextView) findViewById(R.id.dowhat_hotel_date);
        ...
        dowhat_hotel_date.setText(title_tv + "  " + dowhat_date);
    }
    ...
    private class GetXMLTask1 extends AsyncTask<String, Void, Document>{
        ...
        protected void onPostExecute(Document doc) {
            List<Hotel_view> hotel_views = new ArrayList<Hotel_view>();

            NodeList nodeList = doc.getElementsByTagName("item");

            for(int i = 0; i< nodeList.getLength(); i++) {
                Hotel_view hotel_view = new Hotel_view();
                ...
                hotel_view.setNum(i+1+"");
                hotel_view.setTitle(title);
                hotel_view.setImgURL(url);
                hotel_view.setInfo(overview);
                hotel_view.setAddress(address);
                hotel_view.setTel(tel);

                hotel_views.add(hotel_view);
            ...
            recyclerview.setAdapter(new MyHotelAdapter(hotel_views, R.layout.activity_hotel_view));
