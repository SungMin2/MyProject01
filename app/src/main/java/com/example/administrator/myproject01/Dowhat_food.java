...
public class Dowhat_food extends AppCompatActivity {
    LinearLayout layout = null;
    RecyclerView recyclerview;
    TextView dowhat_food_date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dowhat_food);

        recyclerview = (RecyclerView) findViewById(R.id.food_rv);

        GetXMLTask1 task1 = new GetXMLTask1();
        task1.execute("http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList?serviceKey=JI5iaAMofKW0PgTEzjqzA38Ut65niZWOSb2qDUs%2BXHVBM10SOY8toEJhq4ESw0rWBNtG%2BBIVJNMXNDkSt9H15g%3D%3D&MobileOS=AND&MobileApp=MyProject01&arrange=C&numOfRows=10&contentTypeId=39");

        dowhat_food_date = (TextView) findViewById(R.id.dowhat_food_date);
        ...
        dowhat_food_date.setText(title_tv + "  " + dowhat_date);
    }
    ...
    private class GetXMLTask1 extends AsyncTask<String, Void, Document>{
        ...
        protected void onPostExecute(Document doc) {
            List<Food_view> food_views = new ArrayList<Food_view>();

            NodeList nodeList = doc.getElementsByTagName("item");

            for(int i = 0; i< nodeList.getLength(); i++) {
                Food_view food_view = new Food_view();
                ...
                food_view.setNum(i+1+"");
                food_view.setTitle(title);
                food_view.setImgURL(url);
                food_view.setInfo(overview);
                food_view.setAddress(address);
                food_view.setTel(tel);

                food_views.add(food_view);
            ...
            recyclerview.setAdapter(new MyFoodAdapter(food_views, R.layout.activity_food_view));
