...
public class Dowhat_show extends AppCompatActivity {
    LinearLayout layout = null;
    RecyclerView recyclerview;
    TextView dowhat_show_date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dowhat_show);

        recyclerview = (RecyclerView) findViewById(R.id.show_rv);

        GetXMLTask1 task1 = new GetXMLTask1();
        task1.execute("http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList?serviceKey=JI5iaAMofKW0PgTEzjqzA38Ut65niZWOSb2qDUs%2BXHVBM10SOY8toEJhq4ESw0rWBNtG%2BBIVJNMXNDkSt9H15g%3D%3D&MobileOS=AND&MobileApp=MyProject01&arrange=C&numOfRows=10&contentTypeId=14");


        dowhat_show_date = (TextView) findViewById(R.id.dowhat_show_date);
        ...
        dowhat_show_date.setText(title_tv + "  " + dowhat_date);
    }
    ...
    private class GetXMLTask1 extends AsyncTask<String, Void, Document>{
        ...
        protected void onPostExecute(Document doc) {
            List<Show_view> show_views = new ArrayList<Show_view>();

            NodeList nodeList = doc.getElementsByTagName("item");

            for(int i = 0; i< nodeList.getLength(); i++) {
                Show_view show_view = new Show_view();
                ...
                show_view.setNum(i+1+"");
                show_view.setTitle(title);
                show_view.setImgURL(url);
                show_view.setInfo(overview);
                show_view.setAddress(address);
                show_view.setTel(tel);

                show_views.add(show_view);
            ...
            recyclerview.setAdapter(new MyShowAdapter(show_views, R.layout.activity_show_view));
