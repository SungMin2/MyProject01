...
public class Dowhat_heal extends AppCompatActivity {
    LinearLayout layout = null;
    RecyclerView recyclerview;
    TextView dowhat_heal_date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dowhat_heal);

        recyclerview = (RecyclerView) findViewById(R.id.heal_rv);

        GetXMLTask1 task1 = new GetXMLTask1();
        task1.execute("http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList?serviceKey=JI5iaAMofKW0PgTEzjqzA38Ut65niZWOSb2qDUs%2BXHVBM10SOY8toEJhq4ESw0rWBNtG%2BBIVJNMXNDkSt9H15g%3D%3D&MobileOS=AND&MobileApp=MyProject01&arrange=C&numOfRows=10&contentTypeId=25");

        dowhat_heal_date = (TextView) findViewById(R.id.dowhat_heal_date);
        ...
        dowhat_heal_date.setText(title_tv + "  " + dowhat_date);
    }
    ...
    private class GetXMLTask1 extends AsyncTask<String, Void, Document>{
        ...
        protected void onPostExecute(Document doc) {
            List<Heal_view> heal_views = new ArrayList<Heal_view>();

            NodeList nodeList = doc.getElementsByTagName("item");

            for(int i = 0; i< nodeList.getLength(); i++) {
                Heal_view heal_view = new Heal_view();
                ...
                heal_view.setNum(i+1+"");
                heal_view.setTitle(title);
                heal_view.setImgURL(url);
                heal_view.setInfo(overview);
                heal_view.setAddress(address);
                heal_view.setTel(tel);

                heal_views.add(heal_view);
            ...
            recyclerview.setAdapter(new MyHealAdapter(heal_views, R.layout.activity_heal_view));
