...
public class Eatwhat_yangsik extends AppCompatActivity {
    LinearLayout layout = null;
    RecyclerView recyclerview;
    TextView eatwhat_yangsik_date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eatwhat_yangsik);

        recyclerview = (RecyclerView) findViewById(R.id.yangsik_rv);

        GetXMLTask1 task1 = new GetXMLTask1();
        task1.execute("http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList?serviceKey=JI5iaAMofKW0PgTEzjqzA38Ut65niZWOSb2qDUs%2BXHVBM10SOY8toEJhq4ESw0rWBNtG%2BBIVJNMXNDkSt9H15g%3D%3D&MobileOS=AND&MobileApp=MyProject01&arrange=C&numOfRows=10&contentTypeId=39&cat3=A05020200");


        eatwhat_yangsik_date = (TextView) findViewById(R.id.eatwhat_yangsik_date);
        ...
        eatwhat_yangsik_date.setText(title_tv + "  " + eatwhat_date);
    }
    ...
    private class GetXMLTask1 extends AsyncTask<String, Void, Document>{
        ...
        protected void onPostExecute(Document doc) {
            List<Yangsik_view> yangsik_views = new ArrayList<Yangsik_view>();

            NodeList nodeList = doc.getElementsByTagName("item");

            for(int i = 0; i< nodeList.getLength(); i++) {
                Yangsik_view yangsik_view = new Yangsik_view();
                ...
                yangsik_view.setNum(i+1+"");
                yangsik_view.setTitle(title);
                yangsik_view.setImgURL(url);
                yangsik_view.setInfo(overview);
                yangsik_view.setAddress(address);
                yangsik_view.setTel(tel);

                yangsik_views.add(yangsik_view);
            ...
            recyclerview.setAdapter(new MyYangsikAdapter(yangsik_views, R.layout.activity_yangsik_view));
