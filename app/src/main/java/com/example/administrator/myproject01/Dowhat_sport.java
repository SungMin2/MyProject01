...
public class Dowhat_sport extends AppCompatActivity {
    LinearLayout layout = null;
    RecyclerView recyclerview;
    TextView dowhat_sport_date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dowhat_sport);

        recyclerview = (RecyclerView) findViewById(R.id.sport_rv);

        GetXMLTask1 task1 = new GetXMLTask1();
        task1.execute("http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList?serviceKey=JI5iaAMofKW0PgTEzjqzA38Ut65niZWOSb2qDUs%2BXHVBM10SOY8toEJhq4ESw0rWBNtG%2BBIVJNMXNDkSt9H15g%3D%3D&MobileOS=AND&MobileApp=MyProject01&arrange=C&numOfRows=10&contentTypeId=28");


        dowhat_sport_date = (TextView) findViewById(R.id.dowhat_sport_date);
        ...
        dowhat_sport_date.setText(title_tv + "  " + dowhat_date);
    }
    ...
    private class GetXMLTask1 extends AsyncTask<String, Void, Document>{
        ...
        protected void onPostExecute(Document doc) {
            List<Sport_view> sport_views = new ArrayList<Sport_view>();

            NodeList nodeList = doc.getElementsByTagName("item");

            for(int i = 0; i< nodeList.getLength(); i++) {
                Sport_view sport_view = new Sport_view();
                ...
                sport_view.setNum(i+1+"");
                sport_view.setTitle(title);
                sport_view.setImgURL(url);
                sport_view.setInfo(overview);
                sport_view.setAddress(address);
                sport_view.setTel(tel);

                sport_views.add(sport_view);
            ...
            recyclerview.setAdapter(new MySportAdapter(sport_views, R.layout.activity_sport_view));
