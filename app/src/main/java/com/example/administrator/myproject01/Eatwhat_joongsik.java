...
public class Eatwhat_joongsik extends AppCompatActivity {
    LinearLayout layout = null;
    RecyclerView recyclerview;
    TextView eatwhat_joongsik_date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eatwhat_joongsik);

        recyclerview = (RecyclerView) findViewById(R.id.joongsik_rv);

        GetXMLTask1 task1 = new GetXMLTask1();
        task1.execute("http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList?serviceKey=JI5iaAMofKW0PgTEzjqzA38Ut65niZWOSb2qDUs%2BXHVBM10SOY8toEJhq4ESw0rWBNtG%2BBIVJNMXNDkSt9H15g%3D%3D&MobileOS=AND&MobileApp=MyProject01&arrange=C&numOfRows=10&contentTypeId=39&cat3=A05020400");


        eatwhat_joongsik_date = (TextView) findViewById(R.id.eatwhat_joongsik_date);
        ...
        eatwhat_joongsik_date.setText(title_tv + "  " + eatwhat_date);
    }
    ...
    private class GetXMLTask1 extends AsyncTask<String, Void, Document>{
        ...
        protected void onPostExecute(Document doc) {
            List<Joongsik_view> joongsik_views = new ArrayList<Joongsik_view>();

            NodeList nodeList = doc.getElementsByTagName("item");

            for(int i = 0; i< nodeList.getLength(); i++) {
                Joongsik_view joongsik_view = new Joongsik_view();
                ...
                joongsik_view.setNum(i+1+"");
                joongsik_view.setTitle(title);
                joongsik_view.setImgURL(url);
                joongsik_view.setInfo(overview);
                joongsik_view.setAddress(address);
                joongsik_view.setTel(tel);

                joongsik_views.add(joongsik_view);
            ...
            recyclerview.setAdapter(new MyJoongsikAdapter(joongsik_views, R.layout.activity_joongsik_view));
