...
public class Dowhat_festival extends AppCompatActivity {
    LinearLayout layout = null;
    RecyclerView recyclerview;
    TextView dowhat_festival_date;
    String dowhat_date, title_tv;

    String title, address, tel, url, overview;

    List<Festival_view> festival_views = new ArrayList<Festival_view>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dowhat_festival);

        recyclerview = (RecyclerView) findViewById(R.id.festival_rv);

        GetXMLTask1 task1 = new GetXMLTask1();
        task1.execute("http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList?serviceKey=" +
                "JI5iaAMofKW0PgTEzjqzA38Ut65niZWOSb2qDUs%2BXHVBM10SOY8toEJhq4ESw0rWBNtG%2BBIVJNMXNDkSt9H15g%3D%3D" +
                "&MobileOS=AND&MobileApp=MyProject01&arrange=C&numOfRows=10&contentTypeId=15");


        dowhat_festival_date = (TextView) findViewById(R.id.dowhat_festival_date);
        ...
        dowhat_festival_date.setText(title_tv + "  " + dowhat_date);
    }
    ...
    private class GetXMLTask1 extends AsyncTask<String, Void, Document>{
        ...
        protected void onPostExecute(Document doc) {
            ...
            for(int i = 0; i< nodeList.getLength(); i++) {
                Festival_view festival_view = new Festival_view();
                ...
                festival_view.setNum(i+1+"");
                festival_view.setTitle(title);
                festival_view.setImgURL(url);
                festival_view.setInfo(overview);
                festival_view.setAddress(address);
                festival_view.setTel(tel);

                festival_views.add(festival_view);
            ...
            recyclerview.setAdapter(new MyFestivalAdapter(festival_views, R.layout.activity_festival_view));
